...
env CLANG_MODULE_CACHE_PATH="$PROJECT_DIR/.cache/clang" SDKROOT="$SDK_PATH" swiftc \
  -sdk "$SDK_PATH" "$PROJECT_DIR/Sources/Mory/WorkspaceManager.swift" "$PROJECT_DIR/Sources/Mory/ThemeManager.swift" \
  "$PROJECT_DIR/Tests/MacWorkspaceBoundarySmoke.swift" -o "$PROJECT_DIR/.build/mory-workspace-boundaries"
"$PROJECT_DIR/.build/mory-workspace-boundaries"
