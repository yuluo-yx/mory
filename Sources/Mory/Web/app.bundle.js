...
function optimizeMarkdownTypography(markdown, spacingText) {
...
const mermaidColorThemes = ["auto", "ocean", "forest", "sunset", "mono"];

function normalizeMermaidColorTheme(value) {
...
function normalizeCalendarDocument(value, fallbackDate = new Date()) {
...
function parseCalendarSource(source) {
  try {
...
function serializeCalendarDocument(value) {
  return JSON.stringify(normalizeCalendarDocument(value), null, 2);
}

function calendarMarkdown(value = new Date()) {
...
function calendarRangeDayCount(start, end) {
...
function formatUpdatedAt(value, locale = "zh-CN") {
...
function mindMapHTML(markdown, title = "Untitled", locale = "zh-CN") {
